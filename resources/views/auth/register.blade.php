...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            <h2 style="margin: 0; font-size: 1.5rem; color: #333;">Регистрация</h2>
        </div>
        
        <form method="POST" action="{{ route('register') }}" class="auth-body">
            @csrf
            ...
            <div style="text-align: center; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #ddd;">
                <p style="color: #666; margin: 0;">Уже есть аккаунт? <a href="{{ route('login') }}" style="color: #B57219; text-decoration: none;">Войти</a></p>
            </div>
        </form>
    </div>
</div>
